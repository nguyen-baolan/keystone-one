...
offerings:
  ...
  services:
    - name: "AI Strategy & Governance"
      description: "Executive-level strategic planning, AI readiness assessment, use case prioritization, and governance framework design suitable for regulated environments."
      deliverables:
    ...
    - name: "Custom AI Infrastructure & Agentic Systems"
...
methodology:
  title: "How we work"
  subtitle: "A structured approach from strategy to production"
  phases:
    - name: "Strategic Audit"
      description: "Deep dive into your organization's current state, AI readiness, operational workflows, and strategic objectives. We identify high-value opportunities and surface potential blockers early."
      duration: "2-4 weeks"
      
    - name: "AI Opportunity Diagnosis"
      description: "Prioritize use cases based on business value, technical feasibility, and time-to-delivery. We quantify expected ROI and define success criteria with your leadership and operations teams."
      duration: "2-3 weeks"
      
    - name: "Roadmap & Architecture"
      description: "Design the technical architecture, data flows, governance controls, and implementation roadmap. We ensure alignment with your existing systems, security requirements, and regulatory constraints."
      duration: "3-4 weeks"
      
    - name: "Implementation"
      description: "Hands-on development and deployment of AI systems into your production environment. Iterative delivery with continuous feedback loops to ensure systems meet real-world operational needs."
      duration: "8-16 weeks"
      
    - name: "Internal Champion Enablement"
      description: "Transfer knowledge and capabilities to your internal teams so they can operate, maintain, and evolve AI systems independently. We provide documentation, training, and ongoing advisory support."
      duration: "4-6 weeks"
